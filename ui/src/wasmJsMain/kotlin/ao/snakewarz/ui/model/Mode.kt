 ...
 *
 * A ladder level and a custom match both run on [Screen.GAME] and differ only in what the player is
...
internal enum class Mode {
    ...
    /** One level of the ladder, which *is* its configuration. */
    LADDER,
    ;
     ...
     * a way through the ladder. The button that opens each is hidden rather than disabled: a control
